...
struct Node *createLL1(int a, int n){
    if(a>n){
        return NULL;
    }
...
struct Node *createLL2(int b, int n){
    if(b>n){
        return NULL;
    }
...
void printLL1(struct Node *head){
    struct Node *temp =head;
    if(head==NULL){
        return;
    }
...
void printLL2(struct Node *head){
    struct Node*temp=head;
    if(head ==NULL){
        return;
    }
...
int main(){
    ...
    printf("Enter b: \n");
    scanf("%d",&b);
    struct Node *head1=createLL1(a,n);
    struct Node *head2=createLL2(b,n);
